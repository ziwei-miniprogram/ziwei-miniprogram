...
@if ($anomalies->isNotEmpty())
    <div class="apple-card" style="border-color:rgba(224,121,111,.4);margin-bottom:24px">
...
<div class="apple-card" style="padding:0;overflow:hidden">
    <p class="section-sub" style="padding:24px 24px 0;margin:0">全局功德流水</p>
    <table class="tbl">
        ...
        @empty
            <tr><td colspan="5" style="color:var(--fg-2);text-align:center;padding:40px">暂无流水</td></tr>
        @endforelse
        </tbody>
    </table>
</div>
